 ...
 * @returns The container block selector corresponding to the highlight tags.
 */
 ...
 * Normally generated by the appropriate function using the supplied highlight tags. This may be used for efficiency.
		...
		chrome.runtime.onMessage.addListener((message: HighlightMessage, sender, sendResponse) => {
			...
			if (
				...
				|| (message.terms !== undefined
					&& (!itemsMatch(terms, message.terms, (a: MatchTerm, b: MatchTerm) => a.phrase === b.phrase)
